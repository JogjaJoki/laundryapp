                        ...
                        <form action="{{ route('admin.layanan.create') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" step="1" name="estimasi" class="form-control" placeholder="Estimasi Pengerjaan" required>
                                </div>
                                <div class="form-group">
                                    <label>Harga Layanan</label>
                                    <input type="number" min="1000" step="100" name="harga" class="form-control" placeholder="Harga Layanan" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
